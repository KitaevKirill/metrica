...
class YandexMetrika
{
    ...
    public function getVisits($days = 60)
    {
        $urlParams = [
            'ids' => '50995868',                        //id счетчика
            'date1' => Carbon::today()->subDays($days)->format('Y-m-d'),    //Начальная дата
            'date2' => Carbon::today()->format('Y-m-d'),                 //Конечная дата
            'metrics' => 'ym:s:visits,ym:s:users',
        ];
        $cacheName = md5(serialize($urlParams));
    ...
    public function getTrafficSource($days = 60)
    {
        $urlParams = [
            'ids' => '50995868',                        //id счетчика
            'date1' => Carbon::today()->subDays($days)->format('Y-m-d'),    //Начальная дата
    ...
    protected function getUsersFromSearch(
        $startDate,
        $endDate
    ) {
        $cacheName = md5(serialize('visits-views-users'
    ...
    protected function getAllUsersWithTrafficSource(
        $startDate,
        $endDate
    ) {
        $cacheName = md5(serialize('visits-views-users'
        ...
        $urlParams = [
            ...
            'date2'      => $endDate,
            'metrics'    => "ym:s:visits,
            ym:s:visits[ym:s:trafficSource=='organic'],
            ym:s:visits[ym:s:trafficSource=='ad'],
            ym:s:visits[ym:s:trafficSource=='social'],
            ym:s:visits[ym:s:visitDuration<6],
            ym:s:visits[ym:s:trafficSource=='organic' AND ym:s:visitDuration<6],
            ym:s:visits[ym:s:trafficSource=='ad' AND ym:s:visitDuration<6],
            ym:s:visits[ym:s:trafficSource=='social' AND ym:s:visitDuration<6]",
            'dimensions' => 'ym:s:date',
            'sort'       => 'ym:s:date',
        ];
    ...
    protected function getUsersWithTrafficSourceAD(
        $startDate,
        $endDate
    ) {
        $cacheName = md5(serialize('visits-views-users'
        ...
        $urlParams = [
            ...
            'date1'      => $startDate,
            'date2'      => $endDate,
            'metrics'    => "ym:s:visits[ym:s:trafficSource=='ad']",
            'dimensions' => 'ym:s:date',
            'sort'       => 'ym:s:date',
        ];
